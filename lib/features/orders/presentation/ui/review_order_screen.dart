              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Center(child: CheckoutStepper(currentStep: 2)),
                    ...
                    OrderSectionCard(
                      ...
                      child: Column(
                        children: [
                          SummaryRow(
                            label: "Subtotal",
                            value: "EGP ${state.subtotal}.00",
                          ),
                          SummaryRow(
                            label: "Shipping",
                            value: "EGP ${state.shipping}.00",
                          ),
                          SummaryRow(
                            label: "Tax",
                            value: "EGP ${state.tax}.00",
                          ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () =>
                            context.read<ReviewOrderCubit>().placeOrder(),
