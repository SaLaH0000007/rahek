  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        // 1. استخدام الـ CustomAppBar اللي طلبته
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(color: AppColors.textSecondary, fontSize: AppSizes.f13.sp),
                          ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("Product Name", style: TextStyle(fontSize: AppSizes.f14.sp, fontWeight: FontWeight.bold)),
                                      Text("Quantity: 1", style: TextStyle(color: AppColors.textSecondary, fontSize: AppSizes.f12.sp)),
                                    ],
                                  ),
                                ),
                                Text("EGP ${state.subtotal}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: AppSizes.f14.sp)),
                              ],
                            ),
                          ),
                          ...
                          OrderSectionCard(
                            ...
                            child: Column(
                              children: [
                                SummaryRow(label: "Subtotal", value: "EGP ${state.subtotal}"),
                                SummaryRow(label: "Shipping", value: "EGP ${state.shipping}"),
                                SummaryRow(label: "Tax", value: "EGP ${state.tax}"),
                                Divider(color: AppColors.border, height: AppSizes.p24.h),
                                SummaryRow(label: "Total", value: "EGP ${state.total}", isBold: true),
                              ],
                            ),
                          ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppSizes.r12.r)),
                                elevation: 0,
                              ),
                              child: Text(
                                "Place Order",
                                style: TextStyle(color: Colors.white, fontSize: AppSizes.f16.sp, fontWeight: FontWeight.bold),
                              ),
                            ),
                          ),
                          SizedBox(height: 20.h),
