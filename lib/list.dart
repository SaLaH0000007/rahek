...
List<Product> products = [
  Product(
    ...
    image: "assets/images/Apple_cider_vinegar.png",
    price: 25.00,
    description:
        "Apple cider vinegar ingredients: Natural apple juice - Acidity regulator - Acid less than 5%",
    rating: 4.5,
    weight: [275],
  ),
  Product(
    ...
    price: 175.00,
    description:
        "Black seed honey (100% natural) Raw honey from black seed flowers and wild herbs, rich in black seed extract, which is rich in antioxidants and known for its health benefits when used regularly. It is beneficial for the immune system and soothing to the respiratory system.",
    rating: 4.0,
    weight: [1000, 500, 250],
  ),
  Product(
    ...
    rating: 3.7,
    description:
        "Black honey, 100% natural ingredients: pure sugarcane juice (approximately 320-640 grams), sugar content: 100%, processing: factory-made and heat-treated.",
    weight: [660, 340],
  ),
  Product(
    id: 6,
    ...
    price: 25,
    description:
        "An extract made from infused flowers is added to drinks and water to impart a distinctive flavor, and is also used as a cosmetic product.",
    rating: 2.9,
    weight: [275],
  ),
  Product(
    ...
    price: 60,
    description:
        "Dark soy sauce is used in cooking and seasoning chicken, meat and fish, and gives a distinctive color to grilled dishes.",
    rating: 4.0,
    weight: [280],
  ),
  Product(
